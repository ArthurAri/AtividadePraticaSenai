    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_turma'])) {
            ...
            if (mysqli_query($conn, $turma_query)) {
                ...
                $message = "Erro ao criar turma: " . mysqli_error($conn);
            }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_atividade'])) {
            ...
            if (mysqli_query($conn, $atividade_query)) {
                ...
                $message = "Erro ao criar atividade: " . mysqli_error($conn);
            }
            header("Location: " . $_SERVER['PHP_SELF'] . "?turma_id=$turma_id");
            exit();
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
            ...
            if (mysqli_query($conn, $delete_query)) {
                ...
                $message = "Erro ao excluir atividade: " . mysqli_error($conn);
            }
            header("Location: " . $_SERVER['PHP_SELF'] . "?turma_id=" . intval($_GET['turma_id']));
            exit();
        }
